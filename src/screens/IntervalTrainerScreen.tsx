 ...
 *
 * Exercise screen for interval recognition training.
...
export const IntervalTrainerScreen: React.FC = () => {
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.answerGrid}>
          {['m3', 'M3', 'P4', 'P5'].map((interval) => (
            <Card key={interval} style={styles.answerCard}>
              <Text style={styles.answerText}>{interval}</Text>
            </Card>
          ))}
        </View>
