/**
 * ChordQualityTrainerScreen
 *
 * Exercise screen for chord quality recognition.
...
export const ChordQualityTrainerScreen: React.FC = () => {
      ...
      <View style={styles.content}>
        ...
        <View style={styles.answerGrid}>
          {['Major', 'Minor'].map((quality) => (
            <Card key={quality} style={styles.answerCard}>
              <Text style={styles.answerText}>{quality}</Text>
            </Card>
          ))}
        </View>
